...
public class GUIForm extends JFrame {
    ...
    private float activationCoefficient; //the float that stores the coefficient
    private String activationCoefficientString; //the string to be converted
    private JTextField errorTextField;
    private boolean fluxVariabilityAnalysisValue = false; //Value read from the checkbox.
    private boolean simulateAllSingleKosValue = false; //Value read from the checkbox.
    private boolean minimizeFluxValue = false; //Value read from the checkbox.
    ...
    public GUIForm() {
         ...
         */
        runDefaultSettingsButton.addActionListener(e -> {
            formError = false;
            ...
            try {
                ...
                //TODO color change not working, Make error message more noticeable.
    ...
    private void runApplication() {
        new Thread(() -> {
            ...
            try {
                ...
                // Identify the third textbox and clicks it note if the textboex are rearanged
                // on kbase this will break
                ...
                //WebElement fluxAnalysisBox =
                //  driver.findElements(By.cssSelector("div[class^='cell code_cell")).get(2);
                ...
                WebElement activCoeParent =
                        driver.findElement(By.cssSelector("div[data-parameter='activation_coefficient']"));
