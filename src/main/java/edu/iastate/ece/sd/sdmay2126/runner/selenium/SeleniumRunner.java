    ...
    public void run() {
        ...
        try {
            while (!stopped) {
                ...
                } catch (RunnerNotInitializedException e) { /* TODO */
                    e.printStackTrace();
                } catch (InvalidApplicationException e) { /* TODO */
                    e.printStackTrace();
                } catch (SeleniumIdentificationException e) { /* TODO */
                    e.printStackTrace();
                }
        ...
        } catch (InterruptedException | JobManagerStoppedException e) { /* TODO */
            e.printStackTrace();
        }
    }
